...
```bash
haverhill-311$ sam local invoke PipelineFunction --event events/event.json
```
...
```bash
aws cloudformation delete-stack --stack-name haverhill-311-stack
```
